...
class RecommendationsTableViewController: UITableViewController {
   ...
   /* var current: Double = 0
    ...
    private var potentialRecomendations: [HealthRecommendation] = [lowBMI,highBMI,highCaloricIntake,lowCaloricIntake,lowActivityFactor,highRestingHeartRate,lowRestingHeartRate]
